 ...
 * receiver) and defaults to `account`. They differ for the autonomous Scout,
 * where KISMET's spender sends/pays but the user's universal account receives.
 * Builder suffix + Zora referral are preserved by the shared builders.
 */
